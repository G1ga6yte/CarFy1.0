...
function RequestsBlock (){
  ...
  return(
     <div className="RequestsBlock statisticBlock">
        <div className="headerBlock G-flex G-align-center G-justify-between">
            <Link onClick={()=>{setActivePage("RequestsHistory")}} to="/partner/requests&history" className="nameBlock G-flex G-align-center">
              <img src={Images.reqIcon} alt=""/>
              {t("homeP.miniHeader2")}
            </Link>
       ...
       <Link onClick={()=>{setActivePage("RequestsHistory")}} to="/partner/requests&history" className="contentBlock G-flex">
         <div className="textContent">
            <p className="grayHeader">{t("homeP.miniHeader5")}</p>
         ...
         <div className="statistic">
           ...
           <div className="states greenLines G-flex">
              <div className="statesBlock G-flex-column"><div className="statesLine"></div>9:00</div>
             <div className="statesBlock G-flex-column"><div className="statesLine"></div>10:00</div>
             <div className="statesBlock G-flex-column"><div style={{height: "75px"}} className="statesLine"></div>11:00</div>
