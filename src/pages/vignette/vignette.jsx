...
function Vignette () {
  ...
  function Daily (){
    ...
    return(<span className="TimeSpan">Until {month} {day} on</span>)
  }
  function Week (){
    const today = new Date()
  ...
  function Year (){
    ...
    return(<span className="TimeSpan">Until {month} {day} on, {year}</span>)
  }
  ...
  return(
     <div className="Vignette G-container">
       ...
       <p className="header">Vignette data</p>
       
       <div className="RegCont">
         <div className="pageInfo">
           <p className="VehicleInfo">Vehicle information:</p>
           <span className="clearRefresh G-align-center"><img src={ImgSvg.refresh} alt=""/>Clear</span>
         </div>
         
         <div className="MainCont G-flex G-justify-between">
           <div className="LeftCont">
             <p className="miniHeader">Vehicle data</p>
             ...
             <div className="vehicleDataBlock G-flex G-justify-between">
               <div className="carNumberInput G-justify-between">
                 ...
                 <input onChange={(event)=>setCarNumber(event.target.value)} placeholder="Enter your car number" className="input1" type="text"/>
               </div>
               <input onChange={(event)=>setVignetteVal(event.target.value)} placeholder="Vignette validity beginning" className="input2" type="text"/>
               
             </div>
             <p className="miniHeader">Vehicle type</p>
             ...
             <div className="vehicleTypeBlock G-flex">
               <div onClick={()=> setActiveType("car")} className={`vehicleType ${activeType === "car" ? "active" : ""}`}>
                 ...
                 <span className="span">Passenger car up to 3.5t</span>
               </div>
               ...
               <div onClick={()=>setActiveType("truck")} className={`vehicleType ${activeType === "truck" ? "active" : ""}`}>
                 ...
                 <span className="span">Delivery up to 3.5 tons</span>
               </div>
               ...
               <div onClick={()=>setActiveType("bus")} className={`vehicleType ${activeType === "bus" ? "active" : ""}`}>
                 ...
                 <span className="span">2 axles bus </span>
               </div>
               
             </div>
             
             <p className="miniHeader">Vignette type</p>
             ...
             <p className="miniHeader">Contact data</p>
           ...
           <div className="TotalCont G-flex-column">
              <div className="reminder">
                <p className="prg">To receive bonuses, log in with your ID and connect to <span>the loyalty program</span></p>
              </div>
             <div className="InputBlock">
               <input placeholder="Promocode" className="Input" type="text"/>
               <span>Apply</span>
             </div>
             <div className="orderTextBlock G-flex-column">
                <p className="headPrg">Order:</p>
               <div className="descriptionLine G-justify-between G-align-center">
                 <span>Vehicle type</span>
                 <span>{activeType === "car" ? "Passenger car up to 3.5t" : activeType === "truck" ? "Delivery up to 3.5 tons" : activeType === "bus" ? "2 axles bus" : "."}</span>
               </div>
               <div className="descriptionLine G-justify-between G-align-center">
                 <span>Vignette type</span>
         ...
         <div className="PaymentMethodCont G-flex-column">
           ...
           <div style={{display: `${paymentBlock ? "flex" : "none"}`}} className="PaymentBlock G-flex-column">
             <p className="miniHeader">Payment method</p>
             ...
             <div className="CardBlock G-align-center">
               ...
               <div className="paymentInfoBlock">
                 <div className="prgBlock G-flex">
                   ...
                   <p className="prg">Payment is protected. Card data is transmitted only in encrypted form via the SSL protocol, protected and processed according to the PCI DSS security standard.</p>
                 </div>
